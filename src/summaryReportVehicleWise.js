...
class SummaryReportVehicleWise extends Component{
    ...
    componentDidMount(){
        this.getSummaryReportVehicleWise();
    }
    
    getSummaryReportVehicleWise(){
        GetData(`emc_vmm_summary_rpt.php?user_id=${this.props.user.PARM_PARTY_ID}&type_id=100&rpt_type=12`)
        .then((result)=>{
...
const mapStateToProps = ({ rootReducer }) => {
  ...
  export default connect(mapStateToProps, null)(SummaryReportVehicleWise);